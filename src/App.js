        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl text-slate-400 max-w-3xl leading-relaxed mb-10">
              Élève Ingénieur d'État en <span className="text-white font-bold">IA & Data Science</span> à l'EMSI Rabat. Spécialisé en <span className="text-blue-400 font-bold">LLM, RAG, et IA Agentique</span>. <span className="text-white font-bold">Software Engineer,Full Stack</span>Passionné par l'innovation technologique appliquée à l'<b>Agriculture & l'AgriTech</b>.
            </p>
